...
compile:
	...
	strip target/x86_64-unknown-linux-musl/release/error-microservice
	mv target/x86_64-unknown-linux-musl/release/error-microservice .

build:
	@echo "Reusing built binary in current directory from make compile"
	@ls -lah ./error-microservice
